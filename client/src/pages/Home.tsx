...
export default function Home() {
  ...
  async function loadData() {
    try {
      ...
      // Filtrar produtos não-destaque por categoria
      let regularProducts = allProductsData.filter((p: Product) => !p.destaque);
      if (selectedCategory) {
        regularProducts = regularProducts.filter((p: Product) => p.categoria === selectedCategory);
      }
