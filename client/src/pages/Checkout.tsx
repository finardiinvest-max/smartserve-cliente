...
export default function Checkout() {
  ...
  // Get label for selected time
  const selectedTimeLabel = useMemo(() => {
    if (!formData.horarioRetirada) return null;
    const selected = timeOptions.find(opt => opt.value === formData.horarioRetirada);
    return selected ? selected.label : null;
  }, [formData.horarioRetirada, timeOptions]);
                  ...
                  {formData.tipoRetirada === 'depois' && (
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={value => setFormData(prev => ({ ...prev, horarioRetirada: value }))}
                      >
                        <SelectTrigger className="w-full">
                          <span>{selectedTimeLabel || 'Selecione um horário'}</span>
                        </SelectTrigger>
                        <SelectContent>
